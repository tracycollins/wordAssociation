            ...
            <Table className={classes.table} size="small">
              ...
              <TableBody>
                <TableRow>
                  ...
                  <TableCell align="right">{props.stats.hashtag.category.left}</TableCell>
                </TableRow>
                <TableRow>
                  <TableCell>neutral</TableCell>
                  <TableCell align="right">{props.stats.hashtag.category.neutral}</TableCell>
                </TableRow>
                <TableRow>
                  <TableCell>right</TableCell>
                  <TableCell align="right">{props.stats.hashtag.category.right}</TableCell>
                </TableRow>
                <TableRow>
                  <TableCell>positive</TableCell>
                  <TableCell align="right">{props.stats.hashtag.category.positive}</TableCell>
                </TableRow>
                <TableRow>
                  <TableCell>negative</TableCell>
                  <TableCell align="right">{props.stats.hashtag.category.negative}</TableCell>
                </TableRow>
              </TableBody>
            </Table>
          </TableContainer>
