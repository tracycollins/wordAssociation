...
// const Model = conn.model(...)
	...
	const wordAssoDb = mongoose.createConnection(config.wordAssoDb, options, function(error){
		if (error) {
	...
	wordAssoDb.on("disconnected", function () {  
