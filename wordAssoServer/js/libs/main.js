window.ControlPanel = function ControlPanel() {
  ...
  const DEFAULT_FONT_SIZE_RATIO_MIN = 0.005;
  const DEFAULT_FONT_SIZE_RATIO_MIN_MIN = 0.001;
  const DEFAULT_FONT_SIZE_RATIO_MIN_MAX = 0.010;

  const DEFAULT_FONT_SIZE_RATIO_MAX = 0.020	;
  const DEFAULT_FONT_SIZE_RATIO_MAX_MIN = 0.010;
  const DEFAULT_FONT_SIZE_RATIO_MAX_MAX = 0.050;
