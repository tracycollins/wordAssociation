window.ControlPanel = function ControlPanel() {
  ...
  const DEFAULT_FONT_SIZE_RATIO_MIN = 0.05;
  const DEFAULT_FONT_SIZE_RATIO_MIN_MIN = 0.01;
  const DEFAULT_FONT_SIZE_RATIO_MIN_MAX = 0.1;

  const DEFAULT_FONT_SIZE_RATIO_MAX = 0.2;
  const DEFAULT_FONT_SIZE_RATIO_MAX_MIN = 0.1;
  const DEFAULT_FONT_SIZE_RATIO_MAX_MAX = 0.5;
