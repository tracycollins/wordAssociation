...
function ViewTreepack() {
  ...
  var maxRadiusRatio = 0.075;

  var sliderPercision = 4;
  ...
  var yFocusPositiveRatio = 0.4;

  var xFocusNegativeRatio = 0.5;
  var yFocusNegativeRatio = 0.6;
  ...
  var yMinRatioLeft = 1.0;
  var yMaxRatioLeft = 1.1;
  ...
  var yMinRatioRight = 1.0;
  var yMaxRatioRight = 1.1;

  var xMinRatioPositive = 0.1;
  var xMaxRatioPositive = 0.9;

  var yMinRatioPositive = 1.1;
  var yMaxRatioPositive = 1.1;

  var xMinRatioNegative = 0.1;
  var xMaxRatioNegative = 0.9;

  var yMinRatioNegative = 1.0;
  var yMaxRatioNegative = 1.1;

  var xMinRatioNeutral = 0.1;
  var xMaxRatioNeutral = 0.9;

  var yMinRatioNeutral = 1.1;
  var yMaxRatioNeutral = 1.1;
...
//============TREEMAP=================================
  ...
  this.addNode = function(nNode) {
    ...
    if (((nNode.nodeType !== "hashtag") 
      ...
      || nNode.isIgnored
      || ((nNode.nodeType === "user") && hideUsersFlag) 
      ) { 
      return;
    }
  ...
  this.initD3timer = function() {
    ...
    simulation = d3.forceSimulation(nodes)
      ...
      }).iterations(collisionIterations).strength(collionStrength))
