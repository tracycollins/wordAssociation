...
function ViewMedia() {
  ...
  var svgMediaLayoutArea = svgMain.append("g")
    .attr("id", "svgMediaLayoutArea")
    .attr("width", width)
    .attr("height", height)
  ...
  var linkSvgGroup = svgMediaLayoutArea.append("svg:g").attr("id", "linkSvgGroup");
  var nodeSvgGroup = svgMediaLayoutArea.append("svg:g").attr("id", "nodeSvgGroup");
  var nodeLabelSvgGroup = svgMediaLayoutArea.append("svg:g").attr("id", "nodeLabelSvgGroup");
  ...
  var panzoomElement = document.getElementById('svgMediaLayoutArea');
