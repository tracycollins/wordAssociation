    ...
    2: [function (require, module, exports) {
      ...
      var SpriteText2D = function (_THREE$Object3D) {
        ...
        function SpriteText2D() {
          ...
          _this.align = options.align || textAlign.center; // this._textAlign = options.align || "center"
    ...
    3: [function (require, module, exports) {
      ...
      var Text2D = function (_THREE$Object3D) {
        ...
        function Text2D() {
          ...
          _this.side = options.side || THREE.DoubleSide; // this._textAlign = options.align || "center"
          // this.anchor = Label.fontAlignAnchor[ this._textAlign ]
        ...
        _createClass(Text2D, [{
          ...
          value: function updateText() {
            ...
            this.mesh.position.y = -this.canvas.height / 2 + this.canvas.textHeight / 2 * this.align.y; // manually update geometry vertices
