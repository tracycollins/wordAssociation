  ...
  return function e(t, n, r) {
    ...
    1: [function (require, module, exports) {
      ...
      function getFontHeight(t) {
        var e = fontHeightCache[t];

        if (!e) {
          var n = document.getElementsByTagName("body")[0],
              i = document.createElement("div"),
              a = document.createTextNode("MÉq");
          i.appendChild(a), i.setAttribute("style", "font:" + t + ";position:absolute;top:0;left:0"), n.appendChild(i), e = i.offsetHeight, fontHeightCache[t] = e, n.removeChild(i);
        }
      ...
      var _createClass = function () {
        ...
        return function (e, n, i) {
          ...
          CanvasText = function () {
        function t() {
          _classCallCheck(this, t), this.textWidth = null, this.textHeight = null, this.canvas = document.createElement("canvas"), this.ctx = this.canvas.getContext("2d");
        }
    ...
    2: [function (require, module, exports) {
      ...
      var _createClass = function () {
        ...
        function e() {
          ...
          var n = _possibleConstructorReturn(this, Object.getPrototypeOf(e).call(this));

          return n._font = i.font || "30px Arial", n._fillStyle = i.fillStyle || "#FFFFFF", n.canvas = new CanvasText(), n.align = i.align || textAlign.center, n.antialias = _typeof("undefined" === i.antialias) ? !0 : i.antialias, n.text = t, n;
        }
    ...
    3: [function (require, module, exports) {
      ...
      var _createClass = function () {
        ...
        function e() {
          ...
          var s = _possibleConstructorReturn(this, Object.getPrototypeOf(e).call(this));

          return s._font = i.font || "30px Arial", s._fillStyle = i.fillStyle || "#FFFFFF", s.canvas = new CanvasText(), s.align = i.align || textAlign.center, s.side = i.side || THREE.DoubleSide, s.antialias = _typeof("undefined" === i.antialias) ? !0 : i.antialias, s.text = t, s;
        }
        ...
        return _inherits(e, t), _createClass(e, [{
          ...
          value: function () {
            this.cleanUp(), this.canvas.drawText(this._text, {
              font: this._font,
              fillStyle: this._fillStyle
            }), this.texture = new THREE.Texture(this.canvas.canvas), this.texture.needsUpdate = !0, this.applyAntiAlias(), this.material ? this.material.map = this.texture : (this.material = new THREE.MeshBasicMaterial({
              map: this.texture,
              side: this.side
    ...
    4: [function (require, module, exports) {
      ...
      module.exports.SpriteText2D = require("./SpriteText2D"), module.exports.Text2D = require("./Text2D"), module.exports.textAlign = require("./textAlign");
    }, {
      "./SpriteText2D": 2,
      "./Text2D": 3,
      "./textAlign": 5
