...
const NodeToolTip = function (props) {
  ...
  }, node.name || node.nodeId), /*#__PURE__*/React.createElement(Typography, null, node.nodeType === "user" ? `@${node.screenName}` : node.nodeType === "hashtag" ? `#${node.nodeId}` : "tweet", " "), /*#__PURE__*/React.createElement(Typography, null, node.location !== undefined ? node.location : "", " ")), /*#__PURE__*/React.createElement(CardContent, null, /*#__PURE__*/React.createElement(Typography, null, node.description || "")), /*#__PURE__*/React.createElement(CardMedia, {
