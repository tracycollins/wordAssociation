...
FLOW_DEFAULT.NODE_RADIUS_MIN = 10;
...
FORCEVIEW_DEFAULT.NODE_RADIUS_MIN = 10;
...
TREEPACK_DEFAULT.NODE_RADIUS_MIN = 10;
...
MEDIAVIEW_DEFAULT.NODE_RADIUS_MIN = 10;
...
if (useStoredConfig) {
  ...
  config.defaultNodeRadiusMin = DEFAULT_NODE_RADIUS_MIN;
  ...
  switch (svt) {
    ...
    case "media":
      ...
      requirejs(["js/libs/sessionViewMedia"], function() {
        ...
        DEFAULT_NODE_RADIUS_MIN = MEDIAVIEW_DEFAULT.NODE_RADIUS_MIN;
