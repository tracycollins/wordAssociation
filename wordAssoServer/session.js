...
keywordHashMap.set('think', palette.green);
keywordHashMap.set('nigga', palette.green);
keywordHashMap.set('niggas', palette.green);
keywordHashMap.set('nigger', palette.green);
keywordHashMap.set('niggers', palette.green);
keywordHashMap.set('negro', palette.green);
keywordHashMap.set('negros', palette.green);
keywordHashMap.set('negroes', palette.green);
keywordHashMap.set('black', palette.green);
keywordHashMap.set('mecca', palette.green);
keywordHashMap.set('god', palette.green);
...
keywordHashMap.set('proud', palette.green);
keywordHashMap.set('grace', palette.green);
keywordHashMap.set('gracious', palette.green);
keywordHashMap.set('equal', palette.green);
keywordHashMap.set('legal', palette.green);
keywordHashMap.set('legalized', palette.green);
keywordHashMap.set('champion', palette.green);
keywordHashMap.set('cellebrate', palette.green);
keywordHashMap.set('cellebrates', palette.green);
keywordHashMap.set('cellebrated', palette.green);
keywordHashMap.set('cellebrating', palette.green);
keywordHashMap.set('activists', palette.green);
keywordHashMap.set('feminist', palette.green);
keywordHashMap.set('feminists', palette.green);
keywordHashMap.set('feminism', palette.green);
keywordHashMap.set('advocate', palette.green);
keywordHashMap.set('advocates', palette.green);
keywordHashMap.set('charity', palette.green);
keywordHashMap.set('inauguration', palette.green);
keywordHashMap.set('inaugurate', palette.green);

keywordHashMap.set('u.s', palette.yellow);
keywordHashMap.set('verdict', palette.yellow);
keywordHashMap.set('least', palette.yellow);
keywordHashMap.set('most', palette.yellow);
keywordHashMap.set('nothing', palette.yellow);
keywordHashMap.set('everything', palette.yellow);
keywordHashMap.set('biased', palette.yellow);
keywordHashMap.set('bias', palette.yellow);
keywordHashMap.set('internet', palette.yellow);
...
keywordHashMap.set('terrorism', palette.red);
keywordHashMap.set('terrorist', palette.red);
...
keywordHashMap.set('matter', palette.yellow);
keywordHashMap.set('matters', palette.yellow);
keywordHashMap.set('pennsylvania', palette.yellow);
keywordHashMap.set('georgia', palette.yellow);
keywordHashMap.set('utah', palette.yellow);
keywordHashMap.set('connecticut', palette.yellow);
keywordHashMap.set('massachusetts', palette.yellow);
keywordHashMap.set('mississippi', palette.yellow);
keywordHashMap.set('nevada', palette.yellow);
keywordHashMap.set('oregon', palette.yellow);
keywordHashMap.set('idaho', palette.yellow);
keywordHashMap.set('rhode', palette.yellow);
keywordHashMap.set('island', palette.yellow);
keywordHashMap.set('maine', palette.yellow);
keywordHashMap.set('new', palette.yellow);
keywordHashMap.set('hampshire', palette.yellow);
keywordHashMap.set('vermont', palette.yellow);
keywordHashMap.set('york', palette.yellow);
keywordHashMap.set('jersey', palette.yellow);
keywordHashMap.set('virginia', palette.yellow);
keywordHashMap.set('tennessee', palette.yellow);
keywordHashMap.set('louisiana', palette.yellow);
keywordHashMap.set('missouri', palette.yellow);
keywordHashMap.set('indiana', palette.yellow);
keywordHashMap.set('ohio', palette.yellow);
keywordHashMap.set('carolina', palette.yellow);
keywordHashMap.set('texas', palette.yellow);
keywordHashMap.set('arizona', palette.yellow);
keywordHashMap.set('wyoming', palette.yellow);
keywordHashMap.set('colorado', palette.yellow);
keywordHashMap.set('oklahoma', palette.yellow);
keywordHashMap.set('north', palette.yellow);
keywordHashMap.set('south', palette.yellow);
keywordHashMap.set('east', palette.yellow);
keywordHashMap.set('west', palette.yellow);
keywordHashMap.set('kansas', palette.yellow);
keywordHashMap.set('nebraska', palette.yellow);
keywordHashMap.set('kentucky', palette.yellow);
keywordHashMap.set('canada', palette.yellow);
keywordHashMap.set('montana', palette.yellow);
keywordHashMap.set('hawaii', palette.yellow);
keywordHashMap.set('alaska', palette.yellow);
keywordHashMap.set('illinois', palette.yellow);
keywordHashMap.set('arkansas', palette.yellow);
keywordHashMap.set('iowa', palette.yellow);
keywordHashMap.set('maryland', palette.yellow);
keywordHashMap.set('alabama', palette.yellow);
keywordHashMap.set('minnesota', palette.yellow);
keywordHashMap.set('law', palette.yellow);
keywordHashMap.set('prince', palette.yellow);
keywordHashMap.set('really', palette.yellow);
keywordHashMap.set('consistent', palette.yellow);
keywordHashMap.set('every', palette.yellow);
keywordHashMap.set('none', palette.yellow);
keywordHashMap.set('big', palette.yellow);
keywordHashMap.set('little', palette.yellow);
keywordHashMap.set('small', palette.yellow);
keywordHashMap.set('large', palette.yellow);
keywordHashMap.set('iraqi', palette.yellow);
keywordHashMap.set('iraqis', palette.yellow);
keywordHashMap.set('policy', palette.yellow);
keywordHashMap.set('policies', palette.yellow);
keywordHashMap.set('germany', palette.yellow);
keywordHashMap.set('election2016', palette.yellow);
keywordHashMap.set('elections', palette.yellow);

keywordHashMap.set('barack', palette.blue);
keywordHashMap.set('bernie', palette.blue);
keywordHashMap.set('clinton', palette.blue);
keywordHashMap.set('billclinton', palette.blue);
keywordHashMap.set('hillaryclinton', palette.blue);
keywordHashMap.set('clintonfoundation', palette.blue);
keywordHashMap.set('chelsea', palette.blue);
keywordHashMap.set('chelseaclinton', palette.blue);
...
keywordHashMap.set('obamacare', palette.blue);
...
keywordHashMap.set('bad', palette.red);
keywordHashMap.set('terrible', palette.red);
keywordHashMap.set('awful', palette.red);
keywordHashMap.set('nasty', palette.red);
keywordHashMap.set('rotten', palette.red);
keywordHashMap.set('donald', palette.red);
keywordHashMap.set('donaldtrump', palette.red);
keywordHashMap.set('realdonaldtrump', palette.red);
...
keywordHashMap.set('unconscionable', palette.red);
keywordHashMap.set('epidemic', palette.red);
keywordHashMap.set('deplorable', palette.red);
keywordHashMap.set('deplorables', palette.red);
keywordHashMap.set('fight', palette.red);
keywordHashMap.set('fights', palette.red);
keywordHashMap.set('fighting', palette.red);
keywordHashMap.set('fought', palette.red);
keywordHashMap.set('sues', palette.red);
keywordHashMap.set('lawsuit', palette.red);
keywordHashMap.set('hack', palette.red);
keywordHashMap.set('hacks', palette.red);
keywordHashMap.set('hacker', palette.red);
keywordHashMap.set('hackers', palette.red);
keywordHashMap.set('hacked', palette.red);
keywordHashMap.set('hacking', palette.red);
keywordHashMap.set('wikileaks', palette.red);
keywordHashMap.set('anonymous', palette.red);
keywordHashMap.set('worse', palette.red);
keywordHashMap.set('worst', palette.red);
keywordHashMap.set('wrong', palette.red);
keywordHashMap.set('wrongs', palette.red);
keywordHashMap.set('wronged', palette.red);
keywordHashMap.set('error', palette.red);
keywordHashMap.set('errors', palette.red);
keywordHashMap.set('err', palette.red);
keywordHashMap.set('errs', palette.red);
keywordHashMap.set('erred', palette.red);
keywordHashMap.set('cancer', palette.red);
keywordHashMap.set('ill', palette.red);
keywordHashMap.set('cancer', palette.red);
keywordHashMap.set('illegal', palette.red);
keywordHashMap.set('illegally', palette.red);
keywordHashMap.set('indicted', palette.red);
keywordHashMap.set('damage', palette.red);
keywordHashMap.set('bug', palette.red);
keywordHashMap.set('bugs', palette.red);
keywordHashMap.set('bugged', palette.red);
