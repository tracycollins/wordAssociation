...
var palette = {
  "black": [0,0,0,1],
  "blue": [33/255,118/255,199/255,1],
  "gray": [112/255,130/255,132/255,1],
  "green": [37/255,194/255,134/255,1],
  "lightgray": [129/255,144/255,144/255,1],
  "mediumgray": [83/255,104/255,112/255,1],
  "red": [209/255,28/255,36/255,1],
  "white": [1,1,1,1],
  "yellow": [165/255,119/255,6/255,1]
};
...
//   "white": [1,1,1],
//   // "lightgray": "#819090",
//   "lightgray": [129,144,144],
//   // "gray": "#708284",
//   "gray": [112,130,132],
//   // "mediumgray": "#536870",
//   "mediumgray": [83,104,112],
//   "darkgray": "#475B62",
//   "darkblue": "#0A2933",
//   "darkerblue": "#042029",
//   "paleryellow": "#FCF4DC",
  ...
  setInterval(function(){
    ...
    if (rxNodeQueueReady && (rxNodeQueue.length > 0)) {
      ...
      if (category) { 
        ...
        newNode.categoryColor = palette.black; 
      }
...
function loadViewType(svt, callback) {
  ...
  requirejs(["js/libs/sessionViewTreepackGpu"], function() {
