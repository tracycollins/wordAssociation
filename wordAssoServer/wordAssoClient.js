...
function addSessionModeForm(mode, callback) {
    ...
    sessionModePromptButton.setAttribute("id", "sessionModePromptButton");
    ...
    sessionModeStreamButton.setAttribute("id", "sessionModeStreamButton");
    ...
    sessionModeUserUserButton.setAttribute("id", "sessionModeUserUserButton");
...
function setSessionModeButton(mode) {

    console.log("setSessionModeButton MODE: " + mode);
