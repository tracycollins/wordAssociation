...
async function initTfeChild(params){
  ...
  let err = await loadMaxInputHashMap({folder: dropboxConfigDefaultTrainingSetsFolder, file: maxInputHashMapFile});
